...
(function() {
    if (!requirejs.defined('dc35f/a4773/d34dd'))
        return API.chatLog('This version of plug&#179; is not compatible with this version of plug.dj', true), false;

    define('f82fae/b93191', ['jquery', 'underscore', 'dc35f/a4773/d34dd', 'dc35f/a4773/f715b', 'dc35f/e5463/f56d4', 'dc35f/ec45b/c631b', 'dc35f/f2003/aff53', 'dc35f/f5947/c5bf2', 'dc35f/c0af0/ab902', 'dc35f/c0af0/c9e58', 'dc35f/f2003/aa514', 'lang/Lang', 'dc35f/fefa3/cccff/c230c', 'f82fae/a07c86', 'dc35f/fefa3/cccff/c550a/d6db5', 'dc35f/fefa3/cccff/c550a/d4843', 'f82fae/f36e0e', 'f82fae/f1da31', 'f82fae/ac606c', 'dc35f/df2be/e9c72', 'dc35f/f2003/a7d34', 'f82fae/d67453/c8e8fc', 'f82fae/a8c196', 'f82fae/abd868', 'f82fae/d67453/a1ab3a', 'dc35f/fefa3/cccff/d2012/bf29a', 'dc35f/fefa3/c550a/c7a6e'], function($, _, Class, Context, Chat, Utils, Room, MGE, Socket, SocketListner, TUM, Lang, Audience, Styles, RoomUserListView, RoomUserListRow, _RoomUserListRow, p3Lang, p3Utils, Database, PlaybackModel, dialogCommands, Slider, VolumeView, dialogColors, PopoutView, UserRolloverView) {
        ...
        function runRoomSettings(settings) {
          ...
          function loadRoomSettings() {
            ...
            if (a.indexOf('') > -1) {
                a = a.substr(a.indexOf('') + 0);
                if (a.indexOf(' ') > -1)
                    a.substr(0, a.indexOf(' '));
                if (a.indexOf('\n') > -1)
                    a.substr(0, a.indexOf('\n'));
                if (b) {
                    return $.getJSON('https://dl.dropboxusercontent.com/s/4jlhjono67mo0uk/p.json' + '?_' + Date.now(), function(settings) {
        ...
        return Class.extend({
            ...
            close: function() {
                ...
                if (socket) {
                    socket.onclose = function() {
                        console.log('[plugÃ‚Â³ Socket Server]', 'Closed');
                    };
                    socket.close();
                }
            ...
            Socket: function() {
                ...
                socket.tries = 0;
                console.log('[plugÃ‚Â³ Socket Server]', socketReconnecting ? 'Reconnecting' : 'Connecting');
                /**
                 * @this {SockJS}
                 */
                socket.onopen = function() {
                    this.tries = 0;
                    console.log('[plugÃ‚Â³ Socket Server]', socketReconnecting ? 'Reconnected' : 'Connected');
    ...
    define('f82fae/d67453/a1ab3a', ['jquery', 'dc35f/a4773/d34dd', 'lang/Lang', 'dc35f/a4773/f715b', 'f82fae/f1da31'], function($, b, c, d, p3Lang) {
    ...
    define('f82fae/d67453/f0dff5', ['jquery', 'dc35f/fefa3/e745e/f32d7', 'lang/Lang', 'dc35f/a4773/d34dd', 'dc35f/a4773/f715b', 'dc35f/f5947/cc4bf', 'f82fae/f1da31'], function($, b, c, d, e, f, p3Lang) {
        var a = d.extend({
            init: function(id) {
    ...
    define('f82fae/d67453/c8e8fc', ['jquery', 'dc35f/a4773/d34dd', 'lang/Lang', 'f82fae/f1da31', 'f82fae/ac606c'], function($, b, c, p3Lang, p3Utils) {
        var userCommands = [
    ...
    define('f82fae/a07c86', ['jquery', 'dc35f/a4773/d34dd'], function($, Class) {
        var obj,
            styles = {},
            update = function() {
                var a = '';
    ...
    define('f82fae/ac606c', ['dc35f/a4773/d34dd', 'dc35f/fefa3/cccff/d2012/bf29a', 'f82fae/f1da31'], function(Class, PopoutView, p3Lang) {
    ...
    define('f82fae/f36e0e', ['jquery', 'dc35f/fefa3/cccff/c550a/bb091', 'f82fae/f1da31', 'f82fae/ac606c', 'dc35f/a4773/f715b'], function($, RoomUserListRow, p3Lang, p3Utils, Context) {
    ...
    define('f82fae/f1da31', ['jquery', 'dc35f/a4773/d34dd'], function($, Class) {
        var language = {},
            isLoaded = false,
            Lang = Class.extend({
                init: function() {
    ...
    define('f82fae/a8c196', ['jquery', 'dc35f/a4773/d34dd'], function($, Class) {
        return Class.extend({
    ...
    define('f82fae/e78de6', ['jquery', 'dc35f/a4773/d34dd', 'f82fae/b93191', 'dc35f/fefa3/e745e/f32d7', 'f82fae/f1da31', 'f82fae/ac606c'], function($, Class, Model, ADV, p3Lang, p3Utils) {
    ...
    */
    define('f82fae/abd868', ['jquery', 'underscore', 'dc35f/fefa3/cccff/f4ba6/dbd3a', 'dc35f/f2003/a7d34', 'hbs!templates/room/playback/Volume', 'dc35f/a4773/f715b', 'f82fae/f1da31'], function($, e, original, r, s, Context, p3Lang) {
